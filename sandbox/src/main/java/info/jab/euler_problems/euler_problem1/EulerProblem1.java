 ...
 *
 * For example, if we list all the natural numbers below 10 that are multiples
 * of 3 or 5, we get 3, 5, 6, 9. The sum of these multiples is 23.
 */
public class EulerProblem1 {
     ...
     */
    public long sumMultiplesOfThreeOrFive(int limit) {
        if (limit <= 0) {
            return 0;
        }
