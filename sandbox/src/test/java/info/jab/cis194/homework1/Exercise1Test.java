...
public class Exercise1Test {
    ...
    public void testToDigits() {
        ...
        // Test zero
        assertTrue(exercise1.toDigits(0).isEmpty());
        
        // Test negative number
        assertTrue(exercise1.toDigits(-17).isEmpty());
    ...
    public void testToDigitsRev() {
        ...
        // Test zero
        assertTrue(exercise1.toDigitsRev(0).isEmpty());
        
        // Test negative number
        assertTrue(exercise1.toDigitsRev(-17).isEmpty());
