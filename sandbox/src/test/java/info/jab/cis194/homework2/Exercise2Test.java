...
/**
 * Tests for Exercise 2: insert function
 */
public class Exercise2Test {
    ...
    public void testInsertUnknownMessage() {
        ...
        // Unknown messages should not be inserted
        assertEquals(tree, result);
    }
    
    @Test
    public void testInsertSmallerTimestamp() {
        LogMessage existingMessage = new LogMessage.LogMessageData(
        ...
        LogMessage newMessage = new LogMessage.LogMessageData(
            new MessageType.Info(), 10, "new"
        );
